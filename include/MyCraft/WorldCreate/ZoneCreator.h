...
namespace MyCraft {
    ...
    public:
        ...
        virtual void AnalysSurface(std::vector<glm::ivec3>&, HeightMap& map, Biomes& biome) const = 0;
    ...
    public:
        ...
        void AnalysSurface(std::vector<glm::ivec3>& spawner, HeightMap& map, Biomes& biome) const override;
    protected:
    private:
    };
